...
// Dynamic imports for contract configs and ABIs by chain (VeryChain only)
...
const abiImports: Record<number, Record<string, () => Promise<{ default: Abi }>>> = {
  4613: {
    GyeFactory: () => import('./4613/abis/GyeFactory.json').then(m => ({ default: m.default as Abi })),
    GyeCircle: () => import('./4613/abis/GyeCircle.json').then(m => ({ default: m.default as Abi })),
  },
}
