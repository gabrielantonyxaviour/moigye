...
/**
 * Hook for claiming payout in fixed-order circles
 * @param circleAddress - The address of the GyeCircle contract
 */
export function useClaimPayout(circleAddress: Address): UseClaimPayoutReturn {
  ...
  /**
   * Claim payout for the current round (FIXED_ORDER method only)
   */
